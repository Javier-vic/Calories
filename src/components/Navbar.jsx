    ...
    return (
        <nav className="navbar navbar-expand-md navbar-toggleable-md fixed-nav px-5 shadow-lg">
            ...
            <div className="container-fluid">
                <Link to="/" className="navbar-brand text-white navbar-title">Calculadora de calor&iacute;as</Link>
                <Link to="/" className="navbar-brand text-white navbar-second-title">Calor&iacute;as</Link>
